...
We encourage you to link:Contribute[contribute], https://jira.springsource.org/browse/XD[submit issues and feature requests], and follow our link:wiki/Guide[Spring XD Guide] to kick the tires of Spring XD. You can follow our progress week by week by looking at our link:wiki/WeeklyDemo[weekly demos]
