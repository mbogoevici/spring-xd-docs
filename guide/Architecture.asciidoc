...
How the processing task is broken down into modules is discussed in the section link:Architecture#container-server-architecture[Container Server Architecture].
