...
----
http | transform --expression=payload.toLowerCase() | transform --expression=payload.reverse() | file
----
...
----
http | transform --expression=payload.toLowerCase() | flibble: transformer --expression=payload.reverse() | file
----
