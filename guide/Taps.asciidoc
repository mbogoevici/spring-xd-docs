...
Note that you cannot currently create a tap on a named channel, a stream whose source is a named channel, or a label. This support is planned for a future release.   
