...
Simply drop _feed.xml_ into the _modules/source_ directory and add the dependencies to the lib directory by copying the following jars from your gradle cache to _${xd.home}/lib_:
