...
Simply drop _feed.xml_ into the _modules/source_ directory and add the dependencies to the lib directory under ${xd.home}/lib by copying the following jars from your gradle cache to ${xd.home}/lib:
