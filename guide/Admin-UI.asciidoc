...
image::images/spring-xd-admin-ui.png[The Spring XD Admin UI]
...
Once a Job has been deployed, they be launched through the Admin UI as well. Navigate to the _Deployments_ tab. Select the job you want to launch and press `Launch`. The following modal dialog should appear:

image::images/spring-xd-admin-ui-launch-job.png[Launch a Batch Job with parameters]

Using this screen, one can define one or more job parameters. Job parameters can be typed and the following Data Types are available:
