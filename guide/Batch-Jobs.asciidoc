...
----
 stream create --name jobStream --definition "http > :myjob"
----
Where "myjob" is the name of the job.

==== Retrieve notification from job upon completion
----
stream create --name jobNotifications --definition ":myjob-notifications >log"
----
