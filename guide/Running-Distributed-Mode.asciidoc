...
----
The commands that are offered for xd-admin include:

* --analytics - The data store that will be used to store the analytics data.  The current default is *redis*
* --help - Displays help for the command arguments.  Help information may be accessed with a -? or -h.  
...
The commands that are offered for xd-container include:

* --analytics - How to persist analytics such as counters and gauges. The current default is *redis* 
