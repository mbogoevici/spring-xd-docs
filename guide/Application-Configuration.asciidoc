...
----
XD_CONFIG_LOCATION\source\twittersearch\twittersearch.properties
----
...
and `XD_CONFIG_LOCATION\source\twitterstream\twitterstream.properties` contains
----
...
and `XD_CONFIG_LOCATION\source\twittersearch\twittersearch.properties` contains
----
consumerKey=${sharedConsumerKey}
consumerSecret=${sharedConsumerSecret}
----
...
. `XD_CONFIG_LOCATION\source\twittersearch\twittersearch.properties`
. `XD_CONFIG_LOCATION\source\twittersearch\twittersearch-default.properties`
. `XD_CONFIG_LOCATION\source\twittersearch\twittersearch-qa.properties`
