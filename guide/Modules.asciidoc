...
xd:>module list
  ...
  ------------------  ---------------------------  -----------------------  ----------------
      file                aggregator                   file                     filejdbc
      gemfire             http-client                  gemfire-json-server      hdfsjdbc
      gemfire-cq          bridge                       gemfire-server           hdfsmongodb
      http                filter                       jdbc                     jdbchdfs
      imap                json-field-extractor         mail                     filepollhdfs
      jms                 json-field-value-filter      mqtt
      mail                json-to-tuple                splunk
      mqtt                object-to-json               tcp
      post                script                       aggregate-counter
      reactor-syslog      splitter                     avro
      syslog-tcp          transform                    counter
      syslog-udp      (c) myprocessor                  field-value-counter
      tail                                             gauge
      tcp                                              hdfs
      tcp-client                                       log
      trigger                                          rabbit
      twittersearch                                    rich-gauge
      twitterstream                                    router
      rabbit
      time
```
