...
=== Creating a Module
This section provides details on how to write and register custom modules. For a quick start, dive into the examples of creating link:CreatingASourceModule[source], link:CreatingAProcessorModule[processor], and link:CreatingASinkModule[sink] modules.
