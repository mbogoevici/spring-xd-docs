...
If you are sure you want the previous milestone release, you can also download the distribution http://repo.springsource.org/libs-milestone/org/springframework/xd/spring-xd/1.0.0.M4/spring-xd-1.0.0.M4.zip[*spring-xd-1.0.0.M4-dist.zip*] and http://repo.springsource.org/libs-milestone/org/springframework/xd/spring-xd/1.0.0.M4/spring-xd-1.0.0.M4-docs.zip[its accompanying documentation]. 
