...
=== Download Spring XD
To download the current release, you can download the distribution http://repo.spring.io/libs-milestone/org/springframework/xd/spring-xd/1.1.0.M1/spring-xd-1.1.0.M1-dist.zip[*spring-xd-1.1.0.M1-dist.zip*] and http://repo.spring.io/libs-milestone/org/springframework/xd/spring-xd/1.1.0.M1/spring-xd-1.1.0.M1-docs.zip[its accompanying documentation]. 
