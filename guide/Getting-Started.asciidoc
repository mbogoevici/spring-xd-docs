...
If you are sure you want the previous milestone release, you can also download the distribution http://repo.springsource.org/libs-milestone/org/springframework/xd/spring-xd/1.0.0.M5/spring-xd-1.0.0.M5-dist.zip[*spring-xd-1.0.0.M5-dist.zip*] and http://repo.springsource.org/libs-milestone/org/springframework/xd/spring-xd/1.0.0.M5/spring-xd-1.0.0.M5-docs.zip[its accompanying documentation]. 

[source,sh]
----
$ cd spring-xd-1.0.0.M5
----
...
\____/| .__/|_|  |_|_| |_|\__, | \/   \/___/
      ...
      |_|                 |___/
eXtreme Data
1.0.0.M5 | Admin Server Target: http://localhost:8080
