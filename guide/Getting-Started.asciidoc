...
=== Download Spring XD
To download the current release, you can download the distribution http://repo.spring.io/release/org/springframework/xd/spring-xd/1.0.0.RELEASE/spring-xd-1.0.0.RELEASE-dist.zip[*spring-xd-1.0.0.RELEASE-dist.zip*] and http://repo.spring.io/release/org/springframework/xd/spring-xd/1.0.0.RELEASE/spring-xd-1.0.0.RELEASE-docs.zip[its accompanying documentation]. 
