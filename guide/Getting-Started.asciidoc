...
Download http://www.springsource.org/download/community?project=Spring%20XD[*spring-xd-1.0.0.M2-dist.zip*]

Unzip the distribution. This will yield the installation directory *spring-xd-1.0.0.M2*. All the commands below are executed from this directory, so change into it before proceeding
...
\____/| .__/|_|  |_|_| |_|\__, | \/   \/___/
      ...
      |_|                 |___/
eXtreme Data
1.0.0.BUILD-SNAPSHOT | Admin Server Target: http://localhost:8080
