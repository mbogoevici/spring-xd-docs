...
=== Download Spring XD
To download the latest Milestone release, you can download the distribution http://repo.spring.io/libs-milestone/org/springframework/xd/spring-xd/1.0.0.RC1/spring-xd-1.0.0.RC1-dist.zip[*spring-xd-1.0.0.RC1-dist.zip*] and http://repo.spring.io/libs-milestone/org/springframework/xd/spring-xd/1.0.0.RC1/spring-xd-1.0.0.RC1-docs.zip[its accompanying documentation]. 

If you want to try out the latest build of Spring XD, You can download the snapshot distribution from http://repo.spring.io/libs-snapshot/org/springframework/xd/spring-xd/1.0.0.BUILD-SNAPSHOT[the spring snapshots repository]. You can also link:Building-Spring-XD#building-spring-xd[build the project from source] if you wish. The wiki content should also be kept up to date with the current snapshot so if you are reading this on the github website, things may have changed since the last milestone.
