...
The shell is a more user-friendly front end to the REST API which Spring XD exposes to clients. The prompt shows the URL of the currently targeted Spring XD server.
