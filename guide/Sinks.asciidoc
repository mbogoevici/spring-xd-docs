 ...
 * year, month, day, hour, minute  (works well with fields of datatype long)
   - specify function plus field name like: `year('timestamp')`
 * dateformat (works well with fields of datatype long)
   - specify function plus field name, a name for the partition and the date format like: `dateFormat('timestamp', 'YEAR-MTH', 'yyyyMM')`
 * range (works well with fields of datatype int)
 ...
 * identity (works well with fields of datatype string and int)
 ...
 * hash (works well with all data types)
