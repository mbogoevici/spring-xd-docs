...
The Avro sink is used to store POJO classes that are sent as the payload on the stream. It uses the http://kitesdk.org/[Kite SDK Dataset] implementation to store the Datasets.
