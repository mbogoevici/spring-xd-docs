 ...
 * hash creates partitions based on the hash created from the value of a field divided into a number of buckets that is specified (works well with all data types)
