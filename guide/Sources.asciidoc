...
destination:: the destination (default is a `queue`) from which messages will be received
...
clientId:: an identifier for the client, to be associated with a durable topic subscription
