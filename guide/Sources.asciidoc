...
query:: The query that will be run against Twitter. For information on how to construct a query, see the https://dev.twitter.com/docs/api/1.1/get/search/tweets[Search API v1.1].
...
NOTE: Both `twittersearch` and `twitterstream` emit JSON in a https://dev.twitter.com/docs/platform-objects/tweets[native Twitter format].  
