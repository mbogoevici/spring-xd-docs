...
https://github.com/SpringSource/spring-xd/wiki/Sources
* <<http, HTTP>>
* <<tail, Tail>>
...
.LF Decoder
     ...
     xd:> stream create --name tcptest2 --definition "tcp --decoder=LF | file"
...
.NULL Decoder
     ...
     xd:> stream create --name tcptest3 --definition "tcp --decoder=NULL | file"
...
.STXETX Decoder
     ...
     xd:> stream create --name tcptest4 --definition "tcp --decoder=STXETX | file"
...
.RAW Decoder
     ...
     xd:> stream create --name tcptest5 --definition "tcp --decoder=RAW | file"
