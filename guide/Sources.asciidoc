...
The _cqtest_ stream is now listening for any stock quote updates for VMW. Ppresumably, another process is updating the cache. You may create a separate stream to test this (see link:GemfireServer).
