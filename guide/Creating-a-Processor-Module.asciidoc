...
Start the XD server and try creating a stream to test your processor:
  ...
  http://localhost:8080:> stream create --name javatweets --definition "twittersearch --query=java --consumerKey=<your_key> --consumerSecret=<your_secret> | tweettransformer | file"
