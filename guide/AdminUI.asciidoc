...
The Step Execution details screen also provides a complete list of all Step Execution Context key/value pairs. For example, the _Spring for Apache Hadoop_ steps provides exhaustive detail information including a link back to the _Job History UI_ of the Hadoop Cluster.
