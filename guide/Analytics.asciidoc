...
Now Post some messages to the ingest stream:
    ...
    http://localhost:8080:> post httpsource --target http://localhost:9090 --data "10"
    http://localhost:8080:> post httpsource --target http://localhost:9090 --data "13"
    http://localhost:8080:> post httpsource --target http://localhost:9090 --data "16"
...
Now Post some messages to the ingest stream:
    ...
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.04}"
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.06}"
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.08}"
...
Now Post some messages to the ingest stream:
    ...
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.92}"
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.90}"
    http://localhost:8080:> post httpsource --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.96}"
