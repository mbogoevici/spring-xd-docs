...
Now Post some messages to the ingest stream:
    ...
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.04}"
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.06}"
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"VMW\",\"price\":72.08}"
...
Now Post some messages to the ingest stream:
    ...
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.92}"
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.90}"
    xd:> http post --target http://localhost:9000 --data "{\"symbol\":\"EMC\",\"price\":24.96}"
