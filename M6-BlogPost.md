...
* [High performance tcp source] - Based on the Reactor project - the [Reactor TCP source](https://github.com/spring-projects/spring-xd/wiki/Sources#reactor-tcp) on commodity hardware can consume ~1 Million msgs/second.
